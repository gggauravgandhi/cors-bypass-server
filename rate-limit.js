...
module.exports = function createRateLimitChecker(CORSANYWHERE_RATELIMIT) {
  ...
  const rateLimitMessage = `Limit is ${maxRequestsPerPeriod} per ${periodInMinutes} minutes.` +
    '\nPowered by cors-anywhere (https://github.com/Rob--W/cors-anywhere#demo-server)';
